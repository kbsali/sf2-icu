...
return array(
    ...
    'BAN' => array(
        'symbol' => 'BAN',
        'name' => 'Bosnia-Herzegovina New Dinar',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'BBD' => array(
    ...
    'BRB' => array(
        'symbol' => 'BRB',
        'name' => 'Brazilian Cruzeiro Novo (1967-1986)',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'BRC' => array(
    ...
    'ECV' => array(
        'symbol' => 'ECV',
        'name' => 'Ecuadorian Unidad de Valor Constante (UVC)',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'EEK' => array(
    ...
    'KRH' => array(
        'symbol' => 'KRH',
        'name' => 'South Korean Hwan',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'KRO' => array(
        'symbol' => 'KRO',
        'name' => 'Old South Korean Won',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'KRW' => array(
    ...
    'XXX' => array(
        'symbol' => 'XXX',
        'name' => 'Unknown or Invalid Currency',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'YDD' => array(
    ...
    'YUD' => array(
        'symbol' => 'YUD',
        'name' => 'Yugoslavian Hard Dinar',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'YUM' => array(
        'symbol' => 'YUM',
        'name' => 'Yugoslavian Noviy Dinar',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'YUN' => array(
        'symbol' => 'YUN',
        'name' => 'Yugoslavian Convertible Dinar',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'YUR' => array(
        'symbol' => 'YUR',
        'name' => 'Yugoslavian Reformed Dinar',
        'fractionDigits' => 2,
        'roundingIncrement' => 0,
    ),
    'ZAL' => array(
